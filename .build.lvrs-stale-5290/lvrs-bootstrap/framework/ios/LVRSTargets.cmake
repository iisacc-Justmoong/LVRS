...
if(NOT TARGET LVRS::LVRS)
    ...
    set_target_properties(LVRS::LVRS PROPERTIES
        IMPORTED_LOCATION "${_IMPORT_PREFIX}/lib/libLVRS.a"
        INTERFACE_COMPILE_DEFINITIONS "LVRS_USE_STATIC_QML_PLUGIN=1"
        INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include/LVRS"
    ...
    if(OFF)
        set_property(TARGET LVRS::LVRS APPEND PROPERTY INTERFACE_LINK_OPTIONS
            "-F${_IMPORT_PREFIX}/lib"
            "-Wl,-rpath,${_IMPORT_PREFIX}/lib"
        )
    endif()
endif()

set(_LVRS_QML_MODULE_PATH "${_IMPORT_PREFIX}/lib/qt6/qml/LVRS")
