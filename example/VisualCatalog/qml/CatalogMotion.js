...
var recipes = {
    ...
    "mobile-navigation-tab": ["navigation", "Compare icon-only and labeled destinations, then focus and activate a tab.", "Optional labels retain LVRS typography, and selection color follows the shared primary color."],
    "mobile-navigation-bar": ["navigation", "Tap different destinations rapidly, use Search, then compare device radii and reduced motion.", "One selection surface stretches forward and settles at the destination; Search stays right and independent."],
