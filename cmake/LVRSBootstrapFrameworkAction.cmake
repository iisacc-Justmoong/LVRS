...
if(NOT DEFINED LVRS_BOOTSTRAP_LVRS_ENABLE_PLATFORM_BUILD_OPTIMIZATIONS)
    set(LVRS_BOOTSTRAP_LVRS_ENABLE_PLATFORM_BUILD_OPTIMIZATIONS "")
endif()
if(NOT DEFINED LVRS_BOOTSTRAP_LVRS_ENABLE_IPO)
    set(LVRS_BOOTSTRAP_LVRS_ENABLE_IPO "")
endif()
...
if(LVRS_BOOTSTRAP_INSTALL_PREFIX MATCHES "/platforms/${LVRS_BOOTSTRAP_PLATFORM}$")
    ...
    set(_lvrs_root_config_version "${LVRS_BOOTSTRAP_INSTALL_PREFIX}/LVRSConfigVersion.cmake")
    ...
    if(EXISTS "${_lvrs_root_config_version}")
        file(COPY_FILE "${_lvrs_root_config_version}" "${_lvrs_install_root}/LVRSConfigVersion.cmake" ONLY_IF_DIFFERENT)
    endif()
endif()
