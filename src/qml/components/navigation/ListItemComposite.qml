...
Column {
    ...
    component BodyText: Label {
        ...
        Layout.preferredHeight: Theme.scaleMetric(13)
        Layout.maximumHeight: Theme.scaleMetric(13)
    }
    ...
    component Glyph: Item {
        ...
        property alias sourceSize: glyphImage.sourceSize
        ...
        Image {
            id: glyphImage
            anchors.fill: parent
            source: RenderQuality.resolveTextureSource(glyph.iconSource.toString().length > 0 ? glyph.iconSource : root.listItem.resolvedAsset(glyph.iconName))
    ...
    component QuantityControl: FocusScope {
        ...
        Layout.maximumWidth: implicitWidth
        Layout.preferredHeight: implicitHeight
        enabled: root.listItem.effectiveStepperEnabled
        ...
        fallback: Component {
            Rectangle {
                ...
                Glyph {
                    ...
                    sourceSize.width: Math.ceil(previewGlyph.width * root.listItem.iconHiDpiScale * root.listItem.iconSupersampleScale)
                    sourceSize.height: Math.ceil(previewGlyph.height * root.listItem.iconHiDpiScale * root.listItem.iconSupersampleScale)
                }
            }
        }
    }
